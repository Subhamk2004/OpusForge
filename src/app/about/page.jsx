          ...
          <div className="w-full rounded-3xl bg-light p-8 lg:p-12">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="w-full lg:w-[40%] h-[300px] lg:h-[400px] border rounded-3xl relative bg-inputbg">
                <div className="absolute inset-0 flex items-center justify-center text-texts">
                  <Image
                    src="https://res.cloudinary.com/dpazarvil/image/upload/v1783528127/assets/havkic9q1xcm4hs0jzc2.jpg"
                    alt="abhisekh"
                    className="rounded-3xl object-cover w-full h-full"
                    width={600}
                    height={600}
              ...
              <div className="w-full lg:w-[60%] flex flex-col justify-start items-start gap-6">
                <div>
                  ...
                  <h3 className="text-lg md:text-xl text-textPurple font-semibold md:mb-4">Abhisekh</h3>
                </div>

                <div className="space-y-4 text-texts leading-relaxed text-sm md:text-base">
                  <p>
                    Hi, I'm Abhisekh,  creator of OpusForge. As a passionate developer myself, I understand the challenges of building a professional portfolio that truly represents your skills and achievements.
                  </p>
                  <p>
                ...
                {/* <div className="flex flex-col sm:flex-row gap-4 w-full">
                  <a
                    href="https://www.linkedin.com/in/subhamk2004"
                    target="_blank"

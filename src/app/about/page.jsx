            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex items-center justify-center gap-4 mb-8">
                <div className="bg-purple p-3 rounded-xl">
                  <Target className="w-8 h-8 text-textPurple" />
                </div>
                <h2 className="text-3xl lg:text-4xl font-bold text-textp">Our Mission</h2>
              </div>

              <div className="space-y-8">
                <p className="text-xl text-texts leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                  <div className="bg-cardbg rounded-2xl p-8 shadow-soft border border-border-light">
                    <div className="flex items-center gap-4 mb-4">
                      <Lightbulb className="w-8 h-8 text-textPurple" />
                      <h3 className="text-2xl font-semibold text-textp">Our Vision</h3>
                    </div>
                  ...
                  <div className="bg-cardbg rounded-2xl p-8 shadow-soft border border-border-light">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="text-2xl font-semibold text-textp">Our Values</h3>
                    </div>
                    <p className="text-texts leading-relaxed">
        ...
        <div className="w-full p-6">
          <div className="w-full rounded-3xl bg-light p-8 lg:p-12">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-texts max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {solutions.map((solution, index) => {
                ...
                return (
                  <div key={index} className="bg-cardbg rounded-2xl p-8 shadow-soft hover:shadow-medium transition-all duration-300 border border-border-light">
                    <div className="flex items-start gap-6">
                      <div className="bg-purple p-4 rounded-xl flex-shrink-0">
                        <IconComponent className="w-8 h-8 text-textPurple" />
                      </div>
                      <div>
                        <h3 className="text-xl font-semibold text-textp mb-3">{solution.title}</h3>
                        <p className="text-texts leading-relaxed">{solution.description}</p>
                      </div>
                    </div>
                  </div>
                );
            ...
            <div className="mt-12 p-8 bg-purple rounded-2xl text-center">
        ...
        <div className="w-full p-6">
          <div className="w-full rounded-3xl bg-light p-8 lg:p-12">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="w-full lg:w-[60%] flex flex-col justify-start items-start gap-6">
                <div>
                  <h2 className="text-3xl lg:text-4xl font-bold text-textp mb-2">Meet the person behind OpusForge</h2>
                  <h3 className="text-xl text-textPurple font-semibold mb-4">Subham Kumar</h3>
                </div>

                <div className="space-y-4 text-texts leading-relaxed">
                  <p>

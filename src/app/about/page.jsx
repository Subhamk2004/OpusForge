            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="w-full lg:w-[60%] flex flex-col justify-start items-start gap-6">
                ...
                <div className="space-y-4 text-texts leading-relaxed text-sm md:text-base">
                  <p>
                    Hi, I'm KBV Kishore,  creator of OpusForge. As a passionate developer myself, I understand the challenges of building a professional portfolio that truly represents your skills and achievements.
                  </p>
                  <p>
